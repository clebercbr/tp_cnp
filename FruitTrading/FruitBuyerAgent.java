...
public class FruitBuyerAgent extends Agent {
	...
	/*
	   ...
	   This is the behaviour used by Fruit-buyer agents to request seller 
	   agents the target Fruit.
	 */
			...
			case 3:      
				...
				if (reply != null) {
					...
					if (reply.getPerformative() == ACLMessage.INFORM) {
						...
						System.out.println(targetFruitTitle+" successfully purchased from agent "+reply.getSender().getName());
