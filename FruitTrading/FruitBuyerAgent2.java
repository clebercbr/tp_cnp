...
public class FruitBuyerAgent extends Agent {
	...
	// Creating the function to create the agents
	public static void main(String[] args) throws Exception {
    	FruitBuyerAgent s = new FruitBuyerAgent();
        s.createAgents();         
    }
    void createAgents() throws Exception{
        for (int i=1; i<10; i++) {
            AgentController ac = cc.createNewAgent("Buyer-agent"+i, "demo.HelloAg", new Object[] { i });
            ac.start();
        }
    }
	// The fruit to buy
